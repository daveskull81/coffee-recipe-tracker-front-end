...
const AddRecipe = ({ currentUser }) => {
    ...
    const onSubmitHandler = e => {
        ...
        apiRequest(currentUser.token)
            .post(`/users/${currentUser.id}/recipes`, { ...recipe, grind_size: selectedGrind, user_id: currentUser.id, method_id: selectedMethod.id, coffee_id: selectedCoffee.id })
            .then(() => {
        ...
        <>
            <Container maxWidth='md'>
                <form onSubmit={onSubmitHandler}>
                    ...
                    <Button color='primary' type='submit'>Add Recipe</Button>
