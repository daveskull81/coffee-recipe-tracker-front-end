      ...
      <CssBaseline />
        <Router>
            ...
            <Switch>
              ...
              <PrivateRoute path='/recipes/new' component={AddRecipe} />
              <PrivateRoute exact path='/recipes/:recipeId' component={SingleRecipe} />
              <PrivateRoute exact path='/recipes/edit/:recipeId' component={EditRecipe} />
            </Switch>
        </Router>
    </>
  );
